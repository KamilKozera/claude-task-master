...
If you don't have an Anthropic or Perplexity API key, you can use Task Master CLI with Cursor's built-in Claude 3.7 Sonnet:

1. Run Task Master commands without setting the ANTHROPIC_API_KEY environment variable
